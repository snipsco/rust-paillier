...
mod rampinstance
{
    ...
    pub type RampPackedPaillier = ::packed::Scheme<u64, RampBigInteger>;
...
mod numinstance
{
    ...
    pub type NumPackedPaillier = ::packed::Scheme<u64, NumBigInteger>;
...
mod gmpinstance
{
    ...
    pub type GmpPackedPaillier = ::packed::Scheme<u64, GmpBigInteger>;
